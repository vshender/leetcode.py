...
![Intersection example](https://assets.leetcode.com/uploads/2021/03/05/160_statement.png)
...
- $1 \le \texttt{m}, \texttt{n} \le 3 * 10^4$
- $1 \le \texttt{Node.val} \le 10^5$
- $0 \le \texttt{skipA} \le \texttt{m}$
- $0 \le \texttt{skipB} \le \texttt{n}$
